...
# if you don't have requirements.txt, install: fastapi uvicorn sqlalchemy alembic passlib[bcrypt] python-jose[cryptography] chromadb openai redis celery loguru defusedxml
```
